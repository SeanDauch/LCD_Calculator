...
void GPIO_init(){
    ...
    GPIOB_MODER &= ~(3|(3<<2)|(3<<4)|(3<<6)|(3<<8)|(3<<10)|(3<<12)|(3<<14)|(3<<20));
    ...
    GPIOB_PUPDR &= ~(3|(3<<2)|(3<<4)|(3<<6)|(3<<8)|(3<<10)|(3<<12)|(3<<14)|(3<<20));
    GPIOB_PUPDR |= 2|(2<<2)|(2<<4)|(2<<6)|(2<<8)|(2<<10)|(2<<12)|(2<<14)|(2<<20);
}
...
int main(){
    ...
    uint8_t operator_input_pins[9] = {0,1,2,3,4,5,6,7,10};//GPIOB
    char operators[9] = {'+','-','*','/','=','^','<', '.', '%'};
